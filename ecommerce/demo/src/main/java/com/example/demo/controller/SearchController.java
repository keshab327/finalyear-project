...
UserdetailRepository userdetailrepo;
	...
	@GetMapping("/search")
	public String SearchByProductName(HttpServletRequest request,Model model,@RequestParam("key") String productname) {
...
int pageno=0;// productname="skirt";
	...
	if(productpages.getContent().isEmpty()) {
		...
		List<product> products=productrepo.findAllProduct(productname);
	...
	public String SearchByProductNameand_page_no_also_return(HttpServletRequest request,Model model,@PathVariable("key") String productname,@PathVariable("page") int pageno) {
